...
/*
	value[0] = 0x00000000000000ffUL & new_rtc_offset;
	value[1] = (0x000000000000ff00UL & new_rtc_offset)>>8;
	value[2] = (0x0000000000ff0000UL & new_rtc_offset)>>16;
	value[3] = (0x00000000ff000000UL & new_rtc_offset)>>24;
	value[4] = (0x000000ff00000000UL & new_rtc_offset)>>32;
	value[5] = (0x0000ff0000000000UL & new_rtc_offset)>>40;
*/
...
#if 0
	if (IS_ERR(rtc_dd)) {
		dev_err_probe(&pdev->dev, PTR_ERR(rtc_dd), "Can't allocate device structure.\n");
		return PTR_ERR(rtc_dd);
	}
#endif
